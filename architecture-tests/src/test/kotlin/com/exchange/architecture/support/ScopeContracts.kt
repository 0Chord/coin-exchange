...
enum class ScopeProblemCode {
    ...
    UNCLASSIFIED_HTTP_TYPE, CONFLICTING_HTTP_ROLE, UNREGISTERED_CONTROLLER,
    UNCLASSIFIED_APPLICATION_TYPE, CONFLICTING_APPLICATION_ROLE, UNREGISTERED_CONFIGURATION,
    UNRESOLVED_TYPE_HIERARCHY,
}
